package com.example.MShop.dao.impl;

import com.example.MShop.dao.IAdminDAO;
...
public class AdminDAOImpl extends AbstractDAOImpl implements IAdminDAO {
    ...
    public boolean removeHandle(String table, String column, Set<?> ids) throws Exception {
        return super.removeHandle(table, column, ids);
    }

    @Override
    public Integer countHandle(String table, String column, String keyWord) throws Exception {
        return super.countHandle(table, column, keyWord);
    }
